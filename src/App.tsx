...
import type { ActionGenerationMode, ActionOutcome, ActionSummary, GameState, NavKey, ProviderConfig, ScriptPackage, SuggestedAction } from './types'
...
function SettingsScreen({ script, actionMode, onActionModeChange, providerConfig, onProviderChange, onExport, onImport, onImportScript, onReset }: { script: ScriptPackage; actionMode: ActionGenerationMode; onActionModeChange: (mode: ActionGenerationMode) => void; providerConfig: ProviderConfig; onProviderChange: (config: Partial<ProviderConfig>) => void; onExport: () => void; onImport: () => void; onImportScript: () => void; onReset: () => void }) {
